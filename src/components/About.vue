<template>
  <div class="contents" id="about">
    ...
    <div ref="aubTwo" class="aub_one aub_two" :class="{animate:aubTwo}">
      ...
      <h6 class="aub_two_title">以上是i-e亩田领域</h6>
    </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        aubOneTitle: '公司简介',
        aubOneText: '深圳i-e亩田实业有限公司注册资本1000万美元，为中洲资本有限公司(Fung Financial Group Ltd)的全资子公司。公司地处深圳核心地带，仅一河之隔临近香港，对接全球经济，开拓并发展新业务。风速实业基于良好的信誉和资源优势，与海内外机构有紧密联系和深度合作，取得最大力度的业务支持，令我们的客户能获得国际上最快捷和全面的资讯，享受优质的投资咨询服务。公司80后和90后员工占比超过90%，凝聚活力与成长，打造精品服务，持续从而提高资产质量、优化资本和产业结构，促进行业健康良好发展。',
        aubTwoeTitle: '投资背景',
