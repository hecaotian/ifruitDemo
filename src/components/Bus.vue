        ...
        buscontes: [
          {
            ...
            bustext: '有赞商城意欲摒除所有无意义于消费者的附加费用，抽丝剥茧，以薄利多销的方式给予消费者价格保障。基于深厚的专业背景和业务资源，风速实业对接多家合作伙伴，减少中间环节，直接获得准确、有效的实时资讯。透明、快捷、稳健的珠宝首饰资讯和电子商务服务，有助于客户了解市场行情，把握机会。客户可通过简单、直观的操作界面，实时掌握资讯及订单执行情况，体验轻松购物。'
          },
          {
            title: '运维中心',
            float_r: true,
